...
parse_env app/src/main/res/layout/account_setup.xml
parse_env app/src/main/res/values/setup.xml
parse_env app/build.gradle

./gradlew assembleGenericRelease
mv app/build/outputs/apk/generic/release/generic-release-*.apk $leviia_app_prefix-release.apk

./gradlew assembleGenericDebug
mv app/build/outputs/apk/generic/debug/generic-debug-*.apk $leviia_app_prefix-debug.apk
